    ...
    public class ToClaimTheirBones : BaseSkillState
    {
        ...
        public override void OnEnter()
        {
            ...
            attack = new()
            {
                ...
                damageType = DamageType.ApplyMercExpose | DamageType.BonusToLowHealth | DamageType.CrippleOnHit | DamageType.SlowOnHit | DamageType.Stun1s,
                teamIndex = base.GetTeam(),
                hitEffectPrefab = Paths.GameObject.OmniImpactVFXSlashMerc,
